...
<head>
    ...
    <title>Perpus Digital | Forgot password</title>
...
<body class="bg-silver-300" style="background-image: url(bg.jpg); background-repeat: no-repeat; background-size: cover; position: relative; background-position: 0px -235px;">
    <div class="content">
        <div class="brand text-bold">
            <a class="link" href="index.php" style="font-size: 20px; text-decoration: solid;">Peminjaman Buku Perpustakaan Sekolah</a>
        </div>
