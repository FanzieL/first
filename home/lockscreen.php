...
<head>
    ...
    <title>Perpus Digital | Locked Screen</title>
...
<body style="background-image: url(./assets/img/2.jpg); background-repeat: no-repeat; background-size: cover;" class="bg-info">
    <div class="content">
        <div class="brand">
            <a class="link" href="index.php" style="font-size: 14px;">Perpustakaan Digital</a>
        </div>
        <div>
            ...
            <form class="text-center" id="lock-form" action="proses_lockscren.php" method="post">
                ...
                <div class="form-group">
                    <input style="text-align: center; width: 300px; height: 34px;" class="border-dark-subtle" type="password" name="password" id="password" placeholder="******">
                </div>
                <div class="form-group">
                    <button class="btn btn-dark btn-block" type="submit"> <i class="fa fa-unlock-alt m-r-5"></i>Unlock</button>
                </div>
            </form>
        </div>
    </div>
