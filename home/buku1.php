...
<head>
    ...
    <title>Perpus Digital | Data Buku</title>
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
                            <img src="./assets/img/users/u5.jpg" />
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        ...
                        <a class="btn btn-sm btn-primary" href="" data-toggle="modal" data-target="#pinjamModal"><i class=""></i> Pinjam Buku</a>
                    </div>
                    <div class="ibox-body">
