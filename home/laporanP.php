...
<head>
    ...
    <title>Perpus Digital | Data Laporan Peminjaman</title>
    ...
    <link rel="shortcut icon" type="image" href="./assets/img/logos/perpus.png">
    <!-- PAGE LEVEL STYLES-->
</head>
    ...
    <div class="page-wrapper">
        ...
        <header class="header">
            <div class="page-brand">
                ...
                <span class="brand" style="margin-left: 8px;">
                        <img src="./assets/img/logos/perpus.png" alt="" style="width: 25px; margin-top: 8px;">
                        <span class="brand-tip" style="margin-top: 8px; margin-left: 10px;">Perpus Digital</span>
                    </span>
                    <span class="brand-mini">PD</span>
                </a>
            </div>
        ...
        <div class="content-wrapper">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            $tanggalp = isset($_POST['tanggal_pinjam']) ? $_POST['tanggal_pinjam'] : '';
                            $tanggalk = isset($_POST['tanggal_kembali']) ? $_POST['tanggal_kembali'] : '';
                            $status1 = isset($_POST['status']) ? $_POST['status'] : '';
                        ?>
                        ...
                        <?php }else{ ?>
                            <div class="alert alert-sm alert-primary text-center">
            ...
            <footer class="page-footer">
                <div class="font-13">Copyright © <b>2024</b> - All rights reserved.</div>
